      ...
      btn.addEventListener("click", () => {
        ...
        ws.onmessage = (event) => {
          ...
          if (snippets[0] === "900") {
            ...
            document.getElementById("sec").innerHTML += "(DEF) Detecting to "+nombre+" in "+timing+"ms"+"\r\n";
            document.getElementById("sec").scrollTop += 100;
                    var acmodact = document.getElementById("modact");
					  if (secs.checked == true){
      ...
      if(timing == undefined || timing == "undefined"){
        if(king == useridtext){
          ...
          if(acciones>=2){
            ...
            document.getElementById("sec4").innerHTML = text;
            }
          if (loglimit >= 25){
