...
uid += navigator_info.userAgent.replace(/\D+/g, '');uid += navigator_info.plugins.length;uid += screen_info.height || '';uid += screen_info.width || '';uid += screen_info.pixelDepth || '';
        ...
        var pos;
        var posi;
        var array = [250100646453736243189102050051151906537365123260024,250100646453736243189102050051151906537365600123224,250100646453736243189102050051151906537365768136624,2501006464537361140005373611401823675720128024];
        var text;
